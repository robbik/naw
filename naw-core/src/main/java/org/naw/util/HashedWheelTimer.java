...
import org.naw.util.internal.ConcurrentIdentityHashMap;
import org.naw.util.internal.MapBackedSet;
import org.naw.util.internal.ReusableIterator;
...
public class HashedWheelTimer implements Timer {
    ...
    public Timeout newTimeout(TimerTask task, long delay, TimeUnit unit, String pid, String activityName) {
        ...
        HashedWheelTimeout timeout = new HashedWheelTimeout(task, pid, activityName, currentTime + delay);
        scheduleTimeout(timeout, delay);
        return timeout;
    }

    public Timeout newTimeout(TimerTask task, long deadline, String pid, String activityName) {
        final long currentTime = System.currentTimeMillis();
        ...
        HashedWheelTimeout timeout = new HashedWheelTimeout(task, pid, activityName, deadline);
    ...
    private final class HashedWheelTimeout implements Timeout {
        ...
        HashedWheelTimeout(TimerTask task, String pid, String activityName, long deadline) {
            this.task = task;
            this.pid = pid;
