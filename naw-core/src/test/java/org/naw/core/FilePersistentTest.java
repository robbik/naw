...
public class FilePersistentTest {
	...
	public void timeoutTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:T1"));
	...
	public void doubleReceiveTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:T2"));
	...
	public void receiveAndDoubleSendTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:T3"));
	...
	public void sendNoReceiveTest() throws Exception {
		directLink.createLink(new URI("direct-test:T4")).send(new Message("12345678", "abcdef"));
	}

	@Test
	public void receiveAndSendTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:T5"));
	...
	public void sendAndReceiveTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:T6"));
	...
	public void inProcessSingleInvokeTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:A"));
	...
	public void inProcess1DeepInvokeTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:B"));
	...
	public void inProcess2DeepInvokeTest() throws Exception {
		Link link = directLink.createLink(new URI("direct-test:C"));
